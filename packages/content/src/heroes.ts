...
export const HEROES: HeroDef[] = [
  ...
  h("hero.thorn.tess", "Tess", "Paciência com dente", "thornveil", "warden", "rare", { hp: 1080, atk: 52, def: 68, spd: 50, crit: 9 }, { pas: "Cresce depois", cmd: "Seda", ult: "Asfixia doce" }, ownBust("thorn_tess", KIT.guardian), true),
  h("hero.thorn.quin", "Quin", "Pólen de arquivo", "thornveil", "channeler", "rare", { hp: 730, atk: 88, def: 28, spd: 64, crit: 15 }, { pas: "Broto", cmd: "Semente", ult: "Bosque instantâneo" }, ownBust("thorn_quin", KIT.mage), true),
  h("hero.thorn.ashleaf", "Ashleaf", "Folha que queima devagar", "thornveil", "striker", "elite", { hp: 760, atk: 90, def: 28, spd: 82, crit: 20 }, { pas: "Verde-cinza", cmd: "Corte de seiva", ult: "Tempestade baixa" }, ownBust("thorn_ashleaf", KIT.archer), true),
  h("hero.thorn.yew", "Yew", "O pacto pedido", "thornveil", "seer", "rare", { hp: 900, atk: 56, def: 44, spd: 50, crit: 8 }, { pas: "Raiz ouve", cmd: "Cura verde", ult: "Pacto" }, ownBust("thorn_yew", KIT.cleric), true),
  ...
  h("hero.ashen.choir", "Choir", "Ensaio do que ficou", "ashen", "channeler", "elite", { hp: 750, atk: 86, def: 30, spd: 58, crit: 13 }, { pas: "Harmonia rachada", cmd: "Nota", ult: "Requiem curto" }, ownBust("ashen_choir", KIT.mage), true),
  h("hero.ashen.dust", "Dust", "Quem acordou errado", "ashen", "vanguard", "rare", { hp: 1200, atk: 48, def: 78, spd: 44, crit: 8 }, { pas: "Não desmancha", cmd: "Cinza dura", ult: "Coro em pé" }, ownBust("ashen_dust", KIT.guardian), true),
  h("hero.ashen.hymn", "Hymn", "Memória que não perdoa", "ashen", "seer", "rare", { hp: 860, atk: 54, def: 42, spd: 52, crit: 9 }, { pas: "Lembra o golpe", cmd: "Canto", ult: "Nome dos mortos" }, ownBust("ashen_hymn", KIT.cleric), true),
