...
export const HEROES: HeroDef[] = [
  ...
  h("hero.tide.luth", "Luth", "Sal que Corta", "tidebound", "striker", "rare", { hp: 800, atk: 86, def: 32, spd: 80, crit: 16 }, { pas: "Adaptação", cmd: "Corte úmido", ult: "Maré curta" }, undefined, true),
  h("hero.tide.cale", "Cale", "O Arquivo Molhado", "tidebound", "channeler", "rare", { hp: 720, atk: 96, def: 26, spd: 56, crit: 15 }, { pas: "Página nova", cmd: "Gotas", ult: "Nome errado" }, undefined, true),
  h("hero.tide.ivo", "Ivo", "Âncora Cortês", "tidebound", "vanguard", "elite", { hp: 1320, atk: 46, def: 84, spd: 42, crit: 6 }, { pas: "Peso", cmd: "Amarra", ult: "Porto" }, undefined, true),
  ...
  h("hero.thorn.yew", "Yew", "O pacto pedido", "thornveil", "seer", "rare", { hp: 900, atk: 56, def: 44, spd: 50, crit: 8 }, { pas: "Raiz ouve", cmd: "Cura verde", ult: "Pacto" }, undefined, true),
  ...
  h("hero.ashen.choir", "Choir", "Ensaio do que ficou", "ashen", "channeler", "elite", { hp: 750, atk: 86, def: 30, spd: 58, crit: 13 }, { pas: "Harmonia rachada", cmd: "Nota", ult: "Requiem curto" }, undefined, true),
  h("hero.ashen.dust", "Dust", "Quem acordou errado", "ashen", "vanguard", "rare", { hp: 1200, atk: 48, def: 78, spd: 44, crit: 8 }, { pas: "Não desmancha", cmd: "Cinza dura", ult: "Coro em pé" }, undefined, true),
  h("hero.ashen.hymn", "Hymn", "Memória que não perdoa", "ashen", "seer", "rare", { hp: 860, atk: 54, def: 42, spd: 52, crit: 9 }, { pas: "Lembra o golpe", cmd: "Canto", ult: "Nome dos mortos" }, undefined, true),
  h("hero.ashen.cinder", "Cinder", "Brasa no arquivo", "ashen", "warden", "elite", { hp: 1120, atk: 52, def: 74, spd: 48, crit: 8 }, { pas: "Restos", cmd: "Protege o ensaio", ult: "Fumaça densa" }, undefined, true),
  h("hero.ashen.veil", "Veil", "Sombra educada", "ashen", "striker", "rare", { hp: 720, atk: 92, def: 24, spd: 90, crit: 24 }, { pas: "Sumiu", cmd: "Corte de véu", ult: "Risada" }, undefined, true),
